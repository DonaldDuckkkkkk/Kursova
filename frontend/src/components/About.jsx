...
export default function About() {
  const goals = [
    ...
    { icon: Users, title: "Розвиток", text: "Підвищення кваліфікації вчителів фізичної культури" },
    { icon: School, title: "Інфраструктура", text: "Модернізація спортивних майданчиків у закладах освіти" },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {[
              ...
              { value: "16 000+", label: "шкіл під наглядом" },
